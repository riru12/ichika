<script>
    ...
    export let data;
    console.log(data);
    console.log(data.manga._id)
</script>


<section class="flex flex-col items-center mt-8 gap-8">
    <div class="flex md:flex-row flex-col w-1/2 md:gap-6 gap-4">
        ...
        <div class="flex flex-col flex-grow justify-around gap-8">
            <div>
            ...
            <div class="flex flex-row gap-2 flex-wrap">
                <a href={`/`} class="w-min md:basis-0 basis-full whitespace-nowrap bg-indigo-700 first-letter px-4 py-2 rounded-xl flex flex-row gap-2 items-center justify-center">
                ...
                <a href={`/manga/${data.manga._id}/update`} class="w-min md:basis-0 basis-full whitespace-nowrap bg-neutral-700 first-letter px-4 py-2 rounded-xl flex flex-row gap-2 items-center justify-center">
                ...
                <a href={`/`} class="w-min md:basis-0 basis-full whitespace-nowrap bg-[#330000] first-letter px-4 py-2 rounded-xl flex flex-row gap-2 items-center justify-center">
