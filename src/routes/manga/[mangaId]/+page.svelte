...
<section class="flex flex-col items-center mt-8 gap-8">
    ...
    <div class="w-3/4 2xl:w-1/2">
        <div class="flex flex-row justify-between">
            ...
            <a href={`/manga/${data.manga._id}/chapter-upload`} class="bg-[#4338ca] rounded-[50%] h-6 w-6 flex justify-center items-center">
        ...
        <div class="flex flex-col gap-1 mt-4">
            {#if data.manga.chapters && data.manga.chapters.length > 0}
                {#each data.manga.chapters as chapters}
                    <a href={`/manga/${data.manga._id}/${chapters.chapterNo}`} class="text-base bg-[#13131a] text-white font-bold px-3 py-1 rounded">
                        <div class="flex flex-row justify-between">
